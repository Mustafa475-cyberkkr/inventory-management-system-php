...
<body dir="rtl">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-center">
                        ...
                        href="Home.php"> <img width="36px" src="The Elements OF Project/icon home-02.png" /> الرئيسية</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="Sellin.php"> <img width="35px" src="The Elements OF Project/icon seles-02.png" /> مبيعات</a></li>
        ...
        <h1 style="margin-top: 5px; padding-top: 20px; text-align: center; color: whitesmoke;"> مــبيعـــات</h1> <br><br>
         </div>
        
         <!--فورم بيانات المبيعات -->
         <div class="container-sm"><br>
            <form action="SellingOp.php" method="post">
              <center>
            ...
            $id =@$_SESSION['search'];#استقبال رقم عملية البيع للبحث
             $result = Search($id,4); #استدعاء دالة البحث حسب رقم العملية ورقم الصفحة
            ?> 
            name="searchSButton">بحث</button>
            <div class="col-sm-6">
            <input style="border-radius: 20px;" type="text" name="searchSelling"
             class="form-control  form-control-sm" id="colFormLabelSm" placeholder="بحث">
             </div></center>

                <div class="form-row">
                  <div class="form-group col-md-1">
                    <label for="inputEmail4"> رقم ID :</label>
                    <input type="text" value=" <?php echo $result[0];?>" class="form-control" name="sellingId" id="userId">
                    
                  </div>
                  <div class="form-group col-md-7">
                    <label for="inputPassword4">اسم الصنف :</label>
                    
                    <select id="inputState"  name="sellingName" class="form-control">
                ...
                <?php #أمر استعلام اسماء الأصناف الموجودة وعرضها في قائمة منسدلة
                 ...
                 ?>
                  ...
                  <div class="form-group col-md-3 ">
                    ...
                    <input type="text" value=" <?php echo $result[2];?>" class="form-control"
                     name="sellingPrice" id="userPhone" placeholder="$">
                  </div>
                  </div>
                <div class="form-row">
                <div class="form-group col-md-6 ">
                    <label for="inputAddress">الخصم %  :</label>
                    <input type="text" value=" <?php echo $result[3];?>" class="form-control" name="sellingDiscount" id="userPhone" placeholder="$">
                  </div>
                  <div class="form-group col-md-5 ">
                    <label for="inputAddress">الكمية :</label>
                    <input type="text" value=" <?php echo $result[4]; }?>" class="form-control" name="sellingAmount" id="userPhone" placeholder="0.0">
                  </div>
                  </div><br>
                   <!--إظهار رسالة العملية-->
        <?php 
        ...
        ?>
                  <!--أزرار العلميات-->
                  <center>
                <button type="submit" name="addSelling" class="btn btn-success col-md-2">إضـافـة</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="submit" name="updateSelling" class="btn btn-warning col-md-2">تعديل</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="submit" name="deleteSelling" class="btn btn-danger col-md-2">حــذف</button>
                 </center>
              </form>
              <br>
         </div>
      ...
      <div class="container-sm ">
       ...
       <div  style="background-color: #176EA3; height: 40px; width: auto;">
        ...
        <table class="table table-bordered table-hover ">
            ...
            echo "</thead>";
            echo " <tbody>";
            $query = mysqli_query($conn,"select * from Selling ");
            while($row = mysqli_fetch_array($query))
            {
              echo"<tr>";
            echo"<td>$row[0]</td>";
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                           <span  class="border border-primary  ">مــبيعـــات</span>
                        </p>
                    </div>
                </div>
            </div>
